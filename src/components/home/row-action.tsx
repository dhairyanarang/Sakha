...
export function RowAction({
  ...
  return (
    <button
      type="button"
      className={cn(
        "flex w-[100px] shrink-0 items-center justify-center rounded-sm px-3 py-3 text-center text-[16px] leading-[1.2] whitespace-nowrap transition-colors disabled:opacity-60",
        tone === "primary"
